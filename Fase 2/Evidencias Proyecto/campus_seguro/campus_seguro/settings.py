...
SECRET_KEY = 'django-insecure-kd$6@6n+6cmtlb7$_k2%0cbtmj0gxey92xs#k#bng6rbm*ayk-'
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # ← Carpeta para archivos estáticos globales
]

# Media files (imágenes subidas por usuarios)
MEDIA_URL = '/media/'

MEDIA_ROOT = BASE_DIR / 'media'  # ← Carpeta para uploads
